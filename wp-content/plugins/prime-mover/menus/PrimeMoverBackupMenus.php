...
{     
    ...
    */
    ...
    public function addRefreshBackupButton()
    {
        ...
        $refresh_url = $this->getSystemFunctions()->primeMoverNonceUrl($backup_menu_url, 'refresh_backups_'.$user_id, 'prime_mover_refresh_backups');
    ...
    public function addBackupsMenuPageCallBack()
    {
      ...
      <div class="wrap prime-mover-backup-menu-wrap">
         ...
         if ($this->getBackupUtilities()->blogIsUsable($blog_id)) {
         ?>
             <p class="edit-site-actions prime-mover-edit-site-actions"><a href="<?php echo esc_url(get_site_url($blog_id)); ?>"><?php esc_html_e('Visit Site', 'prime-mover');?></a> | 
